    ...
    stages {
     ...
     stage('Uploading artifact to S#'){
              ...
              withAWS(credentials: 'L-jenkinsuser', region: 'eu-west-1'){
                  ...
                  s3Upload(file:'project_code/target/debitcardcustomer-0.0.1-SNAPSHOT.war', bucket:'debitcard-app-artifact', path:'${WORKSPACE}/project_code/target/debitcardcustomer-0.0.1-SNAPSHOT.war')
            //  script {
                  //  sh """
